...
mySK = getCustomRan()
myPK = scr.g1mul.call(mySK,h.x,h.y)
...
function reg(){
  unlock(myAddr)
  scr.register.sendTransaction(pkx[myKeyIndex],pky[myKeyIndex],{from:myAddr,value:0})
}
  ...
  listeners[7].watch(function(err, result) {
    ...
    if (verifyResult){
      ...
      if (openCount==commitCount){
        ...
        document.getElementById("instructor").innerHTML = num.dividedBy(2).integerValue().toString(10)
        resetLocalStorage()
        return
      }
    }
